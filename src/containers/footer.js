  ...
  return (
    <Footer>
      <Footer.Frame>
        ...
        >
          <defs></defs>
          <title>Powered By Movie DB</title>
        ...
        <Footer.Text>
          Made by | <Footer.Span>Paras Solanki</Footer.Span>
        </Footer.Text>
        <Footer.Social>
          <Footer.SocialIcon icon={<FaTwitter />} title="Twitter" />
          <Footer.SocialIcon
            href="https://github.com/parasSolanki"
            title="Github"
            icon={<FaGithub />}
          />
          <Footer.SocialIcon title="Linkedin" icon={<FaLinkedin />} />
        </Footer.Social>
      </Footer.Frame>
    </Footer>
  );
